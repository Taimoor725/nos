...
export const MaskContainer = ({
  ...
  return (
    <motion.div
      ...
      animate={{
        backgroundColor: isHovered ? "var(--slate-900)" : "black",
      }}
    >
      <motion.div
...
export default function SvgMask() {
  return (
    <div className="h-screen w-screen flex items-center  justify-center  overflow-hidden ">
      <MaskContainer
        revealText={
          <div className="max-w-4xl mx-auto text-slate-800 text-center  text-4xl font-bold">
            <div className="text-6xl text-red-400 mb-8">Bienvenue</div>
            Bienvenue chez Agence Darwin, là où l'évolution de la communication
            prend vie.
          </div>
        }
      ...
      >
          <div className="max-w-4xl mx-auto text-slate-800 text-center  text-4xl font-bold">
            <div className="text-6xl text-white mb-8 z-10">Bienvenue</div>
          Bienvenue chez Agence Darwin, <span className="text-purple-400">là où l'évolution de la communication
            prend vie.</span>
          </div>
      </MaskContainer>
    </div>
